...
function generateHemorrhagicShockClassQuestion() {
  const classes = [
    { n: 1, loss: 'עד 750cc (עד 15% מנפח הדם)', pulse: 'תקין (60-100)', rr: 'תקין (12-20)', bp: 'תקין' },
    { n: 2, loss: '750-1500cc (15-30% מנפח הדם)', pulse: '100-120', rr: '20-30', bp: 'תקין' },
    { n: 3, loss: '1500-2000cc (30-40% מנפח הדם)', pulse: '120-140', rr: '30-40', bp: 'ירוד' },
    { n: 4, loss: 'מעל 2000cc (מעל 40% מנפח הדם)', pulse: 'מעל 140', rr: 'מעל 35', bp: 'ירוד מאוד' }
  ];
  ...
  return {
    ...
    multi: false,
    section: 'טראומה',
    question: `נפגע טראומה מבוגר מציג: דופק ${cls.pulse}, קצב נשימה ${cls.rr}, לחץ דם סיסטולי ${cls.bp}. באיזו דרגת הלם תת-נפחי (היפוולמי) הוא נמצא, ומהו טווח איבוד הדם המשוער?`,
    options,
    correct: correctLetter,
    explanation: {
      correct: `טבלת דרגות הלם תת-נפחי (מבוגר): דרגה 1 — עד 750cc (עד 15%), דופק תקין 60-100, נשימות תקינות 12-20, ל"ד תקין. דרגה 2 — 750-1500cc (15-30%), דופק 100-120, נשימות 20-30, ל"ד עדיין תקין. דרגה 3 — 1500-2000cc (30-40%), דופק 120-140, נשימות 30-40, ל"ד ירוד. דרגה 4 — מעל 2000cc (מעל 40%), דופק מעל 140, נשימות מעל 35, ל"ד ירוד מאוד. המדדים שבשאלה (דופק ${cls.pulse}, נשימות ${cls.rr}, ל"ד ${cls.bp}) תואמים דרגה ${cls.n}.`,
...
},
{
  ...
  multi: false,
  options: {
    'א': 'תנור/מחולל חשמל בחלל סגור; תסמינים מוקדמים: כאב ראש, בלבול, בחילה ("עור אדום-דובדבן" הוא סימן מאוחר)',
    'ב': 'חשיפה למים מזוהמים; תסמינים: שלשולים והקאות',
    'ג': 'קרינת שמש; תסמינים: כוויות עור',
    'ד': 'אין מקור שכיח מוגדר, המקרים אקראיים לחלוטין'
  },
  correct: 'א',
  explanation: {
    correct: 'מקור נפוץ להרעלת CO בחורף הוא תנור או מחולל חשמל הפועל בחלל סגור. תסמינים: כאב ראש, בלבול, בחילה, וסימן ה"עור האדום-דובדבן" מופיע רק בשלב מאוחר יחסית — לא כסימן ראשוני.',
...
},
{
  ...
  options: {
    'א': 'לשלול הרעלת CO כי הסטורציה תקינה',
    'ב': 'לחשוד בהרעלת CO למרות סטורציה תקינה (מטעה), להוציא לאוויר פתוח, לתת חמצן בריכוז גבוה ולפנות בדחיפות',
    'ג': 'לתת להם להירדם — הישנוניות היא סימן שהם פשוט עייפים',
    'ד': 'לוותר על פינוי כי אין סימנים חמורים'
  },
  correct: 'ב',
  explanation: {
    correct: 'מחולל חשמל בחלל סגור בחורף, עם כאבי ראש וישנוניות אצל שני ילדים, מתאים לתמונה קלאסית של הרעלת CO. הסטורציה נשארת תקינה באופן מטעה כי המכשיר אינו מבחין בין המוגלובין קשור-חמצן להמוגלובין קשור-CO. יש להוציא את הנפגעים לאוויר פתוח, לתת חמצן בריכוז גבוה, ולפנות בדחיפות.',
...
// ================= הטיפול בחולה (35) =================
{ id:'concept_pneumonia_risk_groups', source:'generated', qtype:['concept'], section:'הטיפול בחולה', multi:true,
...
{ id:'concept_pneumonia_causes', source:'generated', qtype:['concept'], section:'הטיפול בחולה', multi:true,
...
{ id:'concept_copd_causes', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_pqrst_meaning', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_socrates_meaning', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_cabg_abbreviation', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_pci_abbreviation', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_medical_abbrevs_multi', source:'generated', qtype:['concept'], section:'הטיפול בחולה', multi:true,
...
{ id:'concept_pain_med_categories', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_statins_ppi_categories', source:'generated', qtype:['concept'], section:'הטיפול בחולה', multi:true,
...
{ id:'concept_thyroid_meds', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_psychiatric_med_categories', source:'generated', qtype:['concept'], section:'הטיפול בחולה', multi:true,
...
{ id:'concept_partial_vs_generalized_seizure', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_petit_mal', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'scenario_dka_presentation', source:'generated', qtype:['scenario'], section:'הטיפול בחולה',
...
{ id:'concept_anaphylaxis_exposure_routes', source:'generated', qtype:['concept'], section:'הטיפול בחולה', multi:true,
...
{ id:'concept_capillary_refill_reliability', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_avpu_pain_response', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_cpss_vs_fast', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'scenario_tia_resolved', source:'generated', qtype:['scenario'], section:'הטיפול בחולה',
...
{ id:'concept_aspirin_chewing_rationale', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_nitrate_side_effects', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'scenario_chest_pain_own_nitrate_no_relief', source:'generated', qtype:['scenario'], section:'הטיפול בחולה',
...
{ id:'concept_mi_gi_symptoms_atypical', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_epistaxis_treatment', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_amputated_part_care', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_internal_bleeding_suspicion', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_pressure_point_technique', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_reasonable_practice_defense', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_never_admit_fault', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_privacy_law_penalty', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_vital_signs_documentation_interval', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_press_spokesperson_only', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_geriatric_history_challenges', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_pediatric_history_challenges', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_hyperglycemia_slow_onset', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
// ================= טראומה (30) =================
{ id:'concept_frontal_collision_pattern', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_rear_side_collision_patterns', source:'generated', qtype:['concept'], section:'טראומה', multi:true,
...
{ id:'concept_motorcycle_injury_pattern', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_pedestrian_impact_phases', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_blast_injury_three_phases', source:'generated', qtype:['concept'], section:'טראומה',
  question:'מהם שלושת שלבי הפגיעה בפגיעת הדף (פיצוץ)?',
  multi:false,
  options:{'א':'ראשוני (גלי לחץ) ← שניוני (רסיסים) ← שלישוני (הטלת גוף)',
    'ב':'שלישוני ← שניוני ← ראשוני','ג':'רק שלב אחד — גלי הלחץ בלבד','ד':'ראשוני (רסיסים) ← שניוני (גלי לחץ) ← שלישוני (כוויות)'},
  correct:'א',
  explanation:{correct:'פגיעות הדף מתחלקות לשלושה שלבים: ראשוני (נזק ישיר מגלי הלחץ, בעיקר לאיברים חלולים כמו ריאות ומעיים), שניוני (פגיעה מרסיסים מעופפים), ושלישוני (פגיעה מהטלת גוף המטופל עצמו על ידי כוח הפיצוץ).',
    wrong:'הסדר ההפוך שגוי; מדובר בשלושה שלבים נפרדים, לא שלב יחיד; והשיוך שבאפשרות ד (רסיסים לראשוני, גלי לחץ לשניוני) הפוך מהנכון.'} },
{ id:'concept_skull_fracture_types', source:'generated', qtype:['concept'], section:'טראומה', multi:true,
  question:'אילו מהבאים הם סוגי שברי גולגולת שנלמדו?',
  options:{'א':'שבר קווי (כ-80% מהמקרים, לרוב ללא נזק מוחי ישיר)','ב':'שבר דחוס (עלול לפגוע ברקמת המוח)','ג':'שבר בסיס גולגולת (סכנת חיים)','ד':'שבר "מעגלי" — אינו סוג מוכר'},
  correct:['א','ב','ג'],
...
{ id:'concept_basilar_skull_fracture_signs', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_icp_perfusion', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_cushings_triad', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_spinal_immobilization_criteria', source:'generated', qtype:['concept'], section:'טראומה',
  question:'מהן ההתוויות לקיבוע מלא של עמוד השדרה (צווארון+לוח+ראש)?',
  multi:false,
  options:{'א':'חבלה קהה + שינוי הכרה, וגם/או רגישות/הגבלה בצוואר/גוף, וגם/או חסר נוירולוגי פריפרי, או חוסר יכולת הערכה (מסיח, בעיות שפה)',
    'ב':'רק אם המטופל מתלונן במפורש על כאב צוואר','ג':'לעולם אין לקבע עמוד שדרה בשטח','ד':'רק בילדים מתחת לגיל 5'},
  correct:'א',
  explanation:{correct:'התוויות לקיבוע מלא: חבלה קהה בשילוב שינוי הכרה, וגם/או רגישות או הגבלת תנועה בצוואר/גוף, וגם/או חסר נוירולוגי פריפרי, או חוסר יכולת לבצע הערכה מהימנה (למשל בשל מסיח כאב אחר או בעיות שפה/תקשורת).',
...
{ id:'concept_simple_pneumothorax_population', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_hemothorax_capacity', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_abdominal_quadrants_organs', source:'generated', qtype:['concept'], section:'טראומה', multi:true,
  question:'אילו מהצירופים הבאים בין רבע בטן לאיברים העיקריים בו נכונים?',
  options:{'א':'ROU (ימין עליון) — כבד/כיס מרה','ב':'LOU (שמאל עליון) — טחול/קיבה','ג':'ROT (ימין תחתון) — תוספתן/מעי דק','ד':'LOT (שמאל תחתון) — כבד וטחול יחד'},
  correct:['א','ב','ג'],
  explanation:{correct:'חלוקת הבטן לרבעים: ROU (ימין עליון) — כבד/כיס מרה. LOU (שמאל עליון) — טחול/קיבה. ROT (ימין תחתון) — תוספתן/מעי דק. LOT (שמאל תחתון) — מעי דק.',
    wrong:'LOT (שמאל תחתון) אינו מכיל כבד וטחול יחד — הכבד ברבע הימני העליון והטחול ברבע השמאלי העליון, לא ברבע התחתון השמאלי.'} },
{ id:'concept_crush_syndrome', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_fracture_complications_multi', source:'generated', qtype:['concept'], section:'טראומה', multi:true,
...
{ id:'concept_dislocation_no_reduction', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_evacuation_decision_factors', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_designated_hospitals_multi', source:'generated', qtype:['concept'], section:'טראומה', multi:true,
...
{ id:'concept_trauma_centers_israel', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_hospital_report_content', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'scenario_rollover_multi_system', source:'generated', qtype:['scenario'], section:'טראומה',
...
{ id:'scenario_open_pneumothorax_field', source:'generated', qtype:['scenario'], section:'טראומה',
...
{ id:'scenario_head_injury_cushing', source:'generated', qtype:['scenario'], section:'טראומה',
...
{ id:'scenario_pregnant_trauma_left_tilt', source:'generated', qtype:['scenario'], section:'טראומה',
...
{ id:'concept_penetrating_object_no_removal', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_kinematics_fall_sequence', source:'generated', qtype:['concept'], section:'טראומה',
...
// ================= החייאה (20) =================
{ id:'concept_clinical_vs_brain_death', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_chain_of_survival_order', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_bls_adult_steps_order', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_child_compression_technique', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_newborn_compression_composition', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_newborn_compression_depth', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_opa_sizes', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_opa_never_twice', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_suction_max_time', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_bvm_volumes', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_cardiopump_purpose', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_certain_death_signs', source:'generated', qtype:['concept'], section:'החייאה', multi:true,
...
{ id:'concept_family_resistance_handling', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_rigor_mortis_lividity', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_mci_priority_life_saving', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_unwitnessed_collapse_reverse', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_fbao_special_populations_multi', source:'generated', qtype:['concept'], section:'החייאה', multi:true,
...
{ id:'concept_mild_vs_severe_choking', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_pre_shock_pause', source:'generated', qtype:['concept'], section:'החייאה',
...
{ id:'concept_homeostasis_definition', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_hierarchy_cell_to_body', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_aerobic_anaerobic', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_cns_pns_composition', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_cranial_spinal_nerves_count', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_vagus_nerve', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_upper_lower_airway', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_alveolus_function', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_lung_volumes', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_inspiration_active_expiration_passive', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_major_arteries_veins', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה', multi:true,
...
{ id:'concept_heart_valves', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_systole_diastole_proportion', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
{ id:'concept_rib_cage_protection', source:'generated', qtype:['concept'], section:'אנטומיה ופיזיולוגיה',
...
// ================= פגיעות סביבתיות (20) =================
{ id:'concept_burn_bsa_child_variant', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_burn_fluid_transport_only', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_chemical_eye_irrigation', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_electrical_burn_internal_worse', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_near_drowning_evaluation', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_diving_barotrauma_types', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_nitrogen_narcosis_vs_oxygen_toxicity', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_air_embolism_diving_danger', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_poisoning_exposure_routes', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות', multi:true,
...
{ id:'concept_poisoning_general_treatment_multi', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות', multi:true,
...
{ id:'concept_co_late_sign_cherry_red', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_insect_sting_removal', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_infectious_disease_awareness_multi', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות', multi:true,
...
{ id:'concept_ppe_legal_mandate', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_exposure_incident_protocol', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_child_abuse_signs_multi', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות', multi:true,
...
{ id:'concept_earthquake_prep_before', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_earthquake_coastal_evac_height', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_earthquake_dont_enter_damaged', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
{ id:'concept_hazmat_general_awareness', source:'generated', qtype:['concept'], section:'פגיעות סביבתיות',
...
// ================= לידה וגניקולוגיה (10) =================
{ id:'concept_obgyn_anamnesis_elements', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
{ id:'concept_three_stages_of_labor', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
{ id:'concept_delivery_kit_prep', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
{ id:'concept_perineal_support', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
{ id:'concept_nuchal_cord', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
{ id:'concept_placenta_previa_vs_abruption', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
{ id:'concept_eclampsia_vs_preeclampsia', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
{ id:'concept_preeclampsia_risk_factors', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה', multi:true,
...
{ id:'concept_scene_differential_obstetric', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
{ id:'concept_newborn_placed_on_mother', source:'generated', qtype:['concept'], section:'לידה וגניקולוגיה',
...
// ================= ציוד רפואי (10) =================
{ id:'concept_o2_hydrostatic_test', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
{ id:'concept_o2_full_tank_validity', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
{ id:'concept_sharps_waste_disposal', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
{ id:'concept_non_sharp_waste', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
{ id:'concept_venflon_parts', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
{ id:'concept_venflon_technique_mistakes', source:'generated', qtype:['concept'], section:'ציוד רפואי', multi:true,
...
{ id:'concept_suction_and_opa_together', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
{ id:'concept_bvm_viral_filter', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
{ id:'concept_ambulance_capacity', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
{ id:'concept_venflon_complication_hematoma', source:'generated', qtype:['concept'], section:'ציוד רפואי',
...
// ================= עבודת הצוות (5) =================
{ id:'concept_mda_founding', source:'generated', qtype:['concept'], section:'עבודת הצוות',
...
{ id:'concept_mda_structure', source:'generated', qtype:['concept'], section:'עבודת הצוות',
...
{ id:'concept_seven_principles_movement', source:'generated', qtype:['concept'], section:'עבודת הצוות',
...
{ id:'concept_mda_average_response_time', source:'generated', qtype:['concept'], section:'עבודת הצוות',
...
{ id:'concept_severe_light_moderate_critical_injury', source:'generated', qtype:['concept'], section:'עבודת הצוות',
...
{ id:'concept_first_aid_goals', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_do_not_do_list', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים', multi:true,
...
{ id:'concept_dont_steal_pledge_law', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_anamnesis_subjective_objective', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_written_record_over_verbal_complaint', source:'generated', qtype:['concept'], section:'קבלת החלטות ודיווחים',
...
{ id:'concept_pain_evaluation_scale', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_disability_pupils_check', source:'generated', qtype:['concept'], section:'הטיפול בחולה',
...
{ id:'concept_kinematics_general_assumption', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_secondary_survey_content', source:'generated', qtype:['concept'], section:'טראומה',
...
{ id:'concept_defib_never_on_pulse', source:'generated', qtype:['concept'], section:'החייאה',
