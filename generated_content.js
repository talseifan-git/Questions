...
{ id: 'GC_0311', source:'generated', qtype:['concept'], section:'החייאה',
  ...
  // 30 שאלות ממודול 15: עזרה ראשונה נפשית וחוסן
  { id: 'GC_0342', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהי עזרה ראשונה נפשית (ער\"ן) ומהן מטרותיה העיקריות?',
    options:{'א':'תחליף לטיפול הרפואי הגופני, הניתן רק לאחר סיום הטיפול הפיזי', 'ב':'חלק בלתי נפרד מהעזרה הראשונה הרפואית, שמטרתה הפחתת חרדה ומצוקה, מניעת התפתחות תגובות נפשיות ממושכות בעקבות אירוע, ומניעת החרפה במצבם הנפשי של מי שכבר סובלים ממחלה נפשית', 'ג':'התערבות המיועדת אך ורק למי שכבר אובחן כחולה נפש', 'ד':'פעולה שתפקידה היחיד הוא לזהות ולדווח על ניסיון אובדני'},
    correct:'ב',
    explanation:{correct:'עזרה ראשונה נפשית אינה תחום נפרד מהעזרה הראשונה הרפואית אלא חלק בלתי נפרד ממנה. מטרותיה: הפחתת רמת החרדה והקלה על הנפגעים; מניעת התפתחות תגובות נפשיות ממושכות (כגון PTSD) בעקבות אירוע; ומניעת החרפה במצבם הנפשי של מי שכבר סובלים ממחלה נפשית.',
  ...
  { id: 'GC_0343', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהו העיקרון המתאר את הקשר בין רמות החוסן השונות (אישי, קבוצתי/צוותי, משפחתי, לאומי)?',
    options:{'א':'כל רמה עומדת בפני עצמה, ללא כל השפעה על האחרות', 'ב':'קיימת זיקת גומלין בין הרמות — חוסן ברמה אחת מזין ומוזן מהחוסן ברמות האחרות (למשל: ככל שחוסן חברי הצוות כפרטים גבוה יותר, כך גובר גם חוסן הצוות כולו וחוסן משפחותיהם)', 'ג':'חוסן לאומי הוא הגורם היחיד המשפיע על כל שאר הרמות', 'ד':'חוסן אישי וחוסן משפחתי הם בדיוק אותו מושג, ואין ביניהם כל הבדל'},
    correct:'ב',
    explanation:{correct:'חוסן קיים בכל הרמות — אישית, קבוצתית/צוותית, משפחתית ולאומית — בזיקת גומלין: ככל שהנסח האישי (הפרטים) המרכיבים קבוצה מסוימת גבוה יותר, כך חוסן הקבוצה כולה גבוה יותר, וכך גם ההפך; חוסן הצוות מחזק גם את חוסן המשפחות וגם את חוסן הארגון כולו.',
  ...
  { id: 'GC_0344', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מדוע נחשב הקשר הטיפולי (הקשר בין המטפל למטופל) לגורם מרכזי בטיפול הנפשי, לעיתים אף בטיפול תרופתי?',
    options:{'א':'כי הוכח במחקרים רבים (למשל על תרופות נוגדות דיכאון) שהשפעת הקשר הטיפולי עשויה להיות דומה או אף לעלות על השפעת התרופה עצמה, כאשר הקשר מבוסס על אמפתיה — היכולת לראות את נקודת המבט של הזולת ולתת לו הרגשה שמבינים אותו', 'ב':'כי הקשר הטיפולי משפיע רק על נפגעים הסובלים מפגיעות גופניות, לא נפשיות', 'ג':'כי מדובר בגורם שולי בהשוואה למינון התרופה, ואינו משפיע כלל על תוצאות הטיפול', 'ד':'כי הקשר הטיפולי רלוונטי אך ורק לאנשי מקצוע מוסמכים בבריאות הנפש, ולא למגישי עזרה ראשונה'},
    correct:'א',
    explanation:{correct:'קשר טיפולי טוב הוא מרכיב מרכזי, לעיתים המרכזי ביותר, בכל טיפול — כולל טיפול תרופתי (למשל אפקט \"פלצבו\" בקרב מחקרים על תרופות נוגדות דיכאון). הוא מבוסס על אמפתיה: יכולת לראות את נקודת מבטו של הזולת ולתת לו הרגשה שמבינים כיצד הוא מרגיש, מתוך תפקיד מקצועי ולא מתוך הזדהות או רחמים. גם מגישי עזרה ראשונה שאינם אנשי מקצוע בבריאות הנפש יכולים ליצור אפקט משמעותי דרך יחס מקצועי ומרגיע.',
  ...
  { id: 'GC_0345', source:'generated', qtype:['scenario'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'הגעת לנפגע החווה מצוקה נפשית קשה בעקבות אירוע חירום. לפי עקרונות יצירת קשר טיפולי, מהו הסדר הנכון לפעול בו?',
    options:{'א':'הציגו עצמכם בשמכם ובתפקידכם ← הביעו נכונות לעזור ← נהלו את המפגש \"בגובה העיניים\" (בישיבה/עמידה/הליכה משותפת) ← הימנעו מהתעמתויות עם הנפגע ← מסרו משוב תומך במהלך המפגש', 'ב':'יש להתחיל תמיד בשאלות אבחוניות מפורטות, עוד לפני כל היכרות עם הנפגע', 'ג':'יש לשמור על מרחק פיזי וריגושי קר ומרוחק, כדי לא \"להיסחף\" רגשית עם הנפגע', 'ד':'יש להימנע מלהציג את עצמכם בשם ובתפקיד, כדי לשמור על אנונימיות המטפל'},
    correct:'א',
    explanation:{correct:'עקרונות יצירת קשר טיפולי: הציגו עצמכם בשמכם ובתפקידכם; הביעו נכונות לעזור לנפגע; נהלו את המפגש \"בגובה העיניים\" (בישיבה/עמידה/הליכה משותפת אם אין פגיעה גופנית); הימנעו מהתעמתויות; ומסרו משוב תומך במהלך המפגש. סדר זה מסייע לבנות אמון ולהוריד את רמת החרדה עוד לפני תחילת הבירור הקליני.',
  ...
  { id: 'GC_0346', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהו \"הכלל הראשון\" בטיפול בנפגע המציג מצב הנראה כהפרעה נפשית?',
    options:{'א':'להתחיל מיד בטיפול תרופתי סימפטומטי, ללא צורך בבדיקה נוספת', 'ב':'לחפש ולשלול בעיה גופנית (כולל פגיעה מוחית/אורגנית) שעלולה להיות הגורם למצב הנפשי הנראה, ע\"י בדיקה גופנית מלאה המתאימה לסיפור הפגיעה', 'ג':'להניח שכל שינוי התנהגותי מקורו נפשי טהור, ולפעול בהתאם ללא בדיקה גופנית', 'ד':'לפנות ישירות לפסיכיאטר, ללא ביצוע כל בדיקה ראשונית בשטח'},
    correct:'ב',
    explanation:{correct:'בכל מצב ער\"ן יש חשיבות עליונה לשלילת גורם גופני/אורגני למצב הנפשי, שכן לחשוד שהמצב נגרם ע\"י פגיעה גופנית או מוחית. יש לבצע בדיקה גופנית מלאה לכל נפגע בהתאם לסיפור הפגיעה, בכל שלב של ההתערבות — ותמיד לחשוד בגורם אורגני כאשר יש שינוי במצב ההכרה.',
  ...
  { id: 'GC_0347', source:'generated', qtype:['scenario'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    ...
    options:{'א':'כי הפרעה במצב ההכרה מרמזת בדרך כלל על פגיעה תפקודית במוח (תרופות, חומרים ממכרים, מצבים גופניים/מטבוליים שונים) שדורשת בירור וטיפול דחוף, ולא רק על מחלה נפשית', 'ב':'כי מצב הכרה מטושטש מעיד תמיד ובאופן ודאי על הפרעת אישיות', 'ג':'כי בדיקה גופנית אינה רלוונטית כלל למצבי בלבול ולכן ניתן לוותר עליה', 'ד':'כי הפרעה במצב ההכרה מעידה תמיד ובוודאות על ניסיון אובדני'},
    correct:'א',
    explanation:{correct:'יש תמיד לחשוד בהפרעה אורגנית כאשר יש פגיעה במצב ההכרה — יש לחפש את הגורם המשפיע על המוח (תרופות, חומרים ממכרים, מצבים גופניים שונים ועוד). לעומת זאת, הפרעות אגו-סינטוניות/הפרעות \"נוירוטיות\" למשל אינן מלוות בהפרעה בהתמצאות ובמצב ההכרה — לכן שינוי במצב ההכרה הוא דגל אדום המחייב חשד לגורם אורגני.',
  ...
  { id: 'GC_0348', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהו ההבדל בין הפרעה \"אורגנית\" להפרעה \"פונקציונלית\"?',
    options:{'א':'הפרעה אורגנית — סיבתה ידועה במוח (לדוגמה הרעלת סמים); הפרעה פונקציונלית — סיבתה במוח אינה ידועה (לדוגמה מחלת הסכיזופרניה)', 'ב':'שני המונחים מתארים בדיוק את אותו סוג של הפרעה, ללא כל הבדל מהותי', 'ג':'הפרעה פונקציונלית פירושה תמיד שהמטופל מעמיד פנים ואינו סובל באמת', 'ד':'הפרעה אורגנית מתייחסת אך ורק להפרעות אישיות'},
    correct:'א',
    explanation:{correct:'החלוקה בין אורגני ל\"פונקציונלי\" מבוססת על ידיעת מקור ההפרעה במוח: הפרעה אורגנית — מקורה ידוע (למשל הרעלת סמים); הפרעה פונקציונלית — סיבתה אינה ידועה בביולוגיה של המוח (למשל מחלת הסכיזופרניה מוגדרת \"פונקציונלית\").',
  ...
  { id: 'GC_0349', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהי המשמעות הקלינית של ההבחנה בין הפרעה \"אגו-דיסטונית\" ל\"אגו-סינטונית\"?',
    options:{'א':'בהפרעה דיסטונית המטופל מודע לבעיה, היא סותרת את תחושת העצמי שלו והוא רוצה טיפול (למשל פוביה); בהפרעה סינטונית — ההפרעה תואמת את תחושת העצמי, והמטופל אינו מכיר בה כבעיה (למשל מצב פסיכוטי כגון סכיזופרניה)', 'ב':'שתי ההגדרות מתארות בדיוק את אותה תופעה ואין ביניהן הבדל מעשי', 'ג':'הפרעה סינטונית פירושה שהמטופל תמיד מבקש טיפול באופן יזום ומודע', 'ד':'הבחנה זו רלוונטית אך ורק להפרעות גופניות, ולא להפרעות נפשיות'},
    correct:'א',
    explanation:{correct:'הפרעה דיסטונית (Ego-Dystonic) סותרת את תחושת העצמי של המטופל — הוא מודע לבעיה ורוצה טיפול (למשל פוביה). הפרעה סינטונית (Ego-Syntonic) תואמת את תחושת העצמי — המטופל אינו מודע/לא מכיר בבעיה (כמו במצב פסיכוטי כגון סכיזופרניה, וגם באישיות נרקיסיסטית). ההבחנה חשובה מאוד לניהול השיחה עם המטופל ולציפיות מהיענותו לטיפול.',
  ...
  { id: 'GC_0350', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:true,
    question:'אילו מהבאים נחשבים לדוגמאות נכונות בסיווג ההפרעות הפסיכיאטריות, לפי החלוקה שהוצגה?',
    options:{'א':'סכיזופרניה ודיכאון מז\'ורי — הפרעות פסיכוטיות המלוות בפגיעה בביקורת המציאות', 'ב':'הפרעות חרדה ופוביות — הפרעות \"נוירוטיות\", המלוות בביקורת מציאות תקינה ובמודעות לבעיה', 'ג':'אישיות נרקיסיסטית — הפרעת אישיות, בדרך כלל אגו-סינטונית', 'ד':'כל ההפרעות הפסיכיאטריות הן בהכרח פסיכוטיות, ללא יוצא מן הכלל'},
    correct:['א', 'ב', 'ג'],
    explanation:{correct:'הסיווג כולל שלוש קבוצות עיקריות: מחלות נפש/הפרעות פסיכוטיות עם פגיעה בביקורת המציאות (כגון סכיזופרניה ודיכאון מז\'ורי); הפרעות \"נוירוטיות\" עם מודעות לבעיה וביקורת מציאות תקינה (כגון פוביות והפרעות חרדה); והפרעות אישיות — מבנה אישיות קבוע הפוגע בתפקוד, לרוב אגו-סינטוני (כגון אישיות נרקיסיסטית).',
  ...
  { id: 'GC_0351', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'אילו שני מרכיבים מרכזיים נבדקים בהערכה הראשונית של מצב נפשי, מעבר לשלילת גורם גופני?',
    options:{'א':'מצב ההכרה וההתמצאות (בזמן, במקום ובזהות), ומצב הרוח (\"אפקט\") ביחס לתאימותו למציאות', 'ב':'אך ורק גובה ומשקל הנפגע', 'ג':'אך ורק ההיסטוריה המשפחתית של הנפגע', 'ד':'אך ורק שם הנפגע ומספר תעודת הזהות שלו'},
    correct:'א',
    explanation:{correct:'בבדיקה יש לברר את מצב ההכרה וההתמצאות (בזמן, במקום ובזהות) — הפרעה בהם מרמזת לרוב על בעיה אורגנית; ואת מצב הרוח (\"אפקט\") של הנבדק — האם הוא תואם את המציאות (למשל דיכאון קיצוני) או אינו תואם אותה (\"אפקט לא תואם\"), שגם הוא עלול להעיד על הפרעה נפשית משמעותית.',
  ...
  { id: 'GC_0352', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהי הגישה הנכונה לבירור סיכון אובדני אצל נפגע, כאשר עולה חשד לכך?',
    options:{'א':'לשאול ישירות ובאופן אמפתי: \"האם ניסית להתאבד או חשבת על כך?\", תוך שמירה על פרטיות הנשאל ומבלי לחשוש מהשאלה עצמה', 'ב':'להימנע לחלוטין משאלה ישירה, מחשש שהיא \"תשתיל\" את הרעיון אצל הנפגע', 'ג':'לשאול על כך רק את בני המשפחה, ולא לפנות ישירות לנפגע עצמו', 'ד':'לדחות את הבירור עד להגעה לבית החולים בלבד, ולא לעסוק בכך בשטח'},
    correct:'א',
    explanation:{correct:'אין לחשוש לשאול את הנבדק שאלה ישירה: \"האם ניסית להתאבד או חשבת על כך?\" — אם עולה חשד לכך, ובצורה אמפתית תוך שמירה על פרטיות הנשאל. שיחה תומכת על מצוקת הנבדק לרוב מקלה על תחושתו, גם כשלא עלה חשד; שאלה ישירה אינה \"משתילה\" רעיון אצל הנבדק. הערכת סיכון אובדני היא חלק חיוני מכל בדיקה נפשית, ואף כשלא עולה חשד — שלילת אובדנות מלאה היא חלק מהבדיקה הפסיכיאטרית המקיפה.',
  ...
  { id: 'GC_0353', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהי התקופה המסוכנת ביותר מבחינת סיכון להתאבדות חוזרת, אצל מי שכבר ניסה להתאבד בעבר?',
    options:{'א':'מ-3 חודשים לאחר ניסיון קודם ועד 10 שנים ואף מעבר לכך', 'ב':'אך ורק היממה הראשונה שלאחר הניסיון', 'ג':'אין קשר בין ניסיון אובדני קודם לסיכון עתידי', 'ד':'הסיכון יורד לאפס לחלוטין כבר בתום שבוע מהניסיון'},
    correct:'א',
    explanation:{correct:'קיימת חפיפה מסוימת בין ניסיונות אובדניים: כ-1/3 ממבצעי ההתאבדות ניסו קודם לכן להתאבד; והתקופה המסוכנת ביותר היא מ-3 חודשים לאחר ניסיון קודם ועד 10 שנים ויותר לאחריו. תוחלת של הפרעה נפשית (בעיקר דיכאון מז\'ורי, התמכרויות וסכיזופרניה) קשורה לרוב מקרי ההתאבדות.',
  ...
  { id: 'GC_0354', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'בהערכת מסוכנות המעשה האובדני (Risk vs. Rescue), אילו שני היבטים נבחנים במקביל?',
    options:{'א':'מידת המסוכנות/אנושות של המעשה עצמו, מול מידת הסבירות שהנפגע יינצל (למשל: מיקום מבודד מול נוכחות אנשים בקרבתו)', 'ב':'אך ורק גילו של הנפגע', 'ג':'אך ורק השאלה האם הנפגע השאיר מכתב פרידה', 'ד':'אך ורק המצב הכלכלי של הנפגע'},
    correct:'א',
    explanation:{correct:'הערכת מסוכנות המעשה (Risk vs. Rescue) בוחנת יחד את מידת אנושות/מסוכנות המעשה עצמו (למשל הריה או קפיצה מגובה רב לעומת נטילת כמות קטנה של תרופה לא מזיקה) מול מידת הסבירות שהנפגע יינצל (למשל מקום מבודד לעומת נוכחות אנשים). שילוב שני ההיבטים מסייע להעריך את חומרת הכוונה האובדנית.',
  ...
  { id: 'GC_0355', source:'generated', qtype:['scenario'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'הגעת לנפגע החשוד כמי שניסה לפגוע בעצמו. אילו פעולות עליך לנקוט בזירה, מעבר לטיפול הרפואי הישיר?',
    options:{'א':'לדאוג לביטחון כל הנוכחים, לוודא שהנפגע אינו חמוש ולהרחיק חפצים וחומרים מסוכנים, ולפעול לפינויו לבירור — במידת הצורך תוך שקילת הפעלת חוק טיפול בחולי נפש, גם ללא הסכמתו', 'ב':'להשאיר את הנפגע לבדו לזמן מה, כדי לתת לו \"מרחב אישי\"', 'ג':'להתמקד אך ורק בטיפול הגופני ולהתעלם לחלוטין מהיבט הבטיחות בזירה', 'ד':'לוותר על ניסיון פינוי אם הנפגע מביע רצון שלא לקבל טיפול, ללא כל בירור נוסף'},
    correct:'א',
    explanation:{correct:'בבדיקת נפגע אובדני יש לדאוג לביטחון כל הנוכחים במקום, לוודא שהנפגע אינו חמוש ולהרחיק חפצים/חומרים מסוכנים, ולפעול לפינוי מתאים. כאשר קיימת סכנה אובדנית ממשית ואין הסכמת המטופל, ניתן לשקול טיפול/אשפוז כפוי לפי חוק טיפול בחולי נפש (במי שכבר אובחן כחולה נפש) או פנייה לחדר מיון כללי לשלילת גורם אורגני, ברוב המקרים תוך שכנוע ולא כפייה מיידית.',
  ...
  { id: 'GC_0356', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'כיצד מוגדרת \"תגובת דחק חריפה\" (ASR — Acute Stress Reaction), ומהו הטווח הנחשב תקין?',
    options:{'א':'תגובה נורמלית לאירוע טראומטי, המתאפיינת ב\"הלם\" וניתוק, ויכולה להימשך משעות עד 3 ימים; אם היא חולפת תוך 72 שעות היא נחשבת תקינה, לא פתולוגית', 'ב':'הפרעה שכבר מוגדרת כפתולוגית מרגע הופעתה, ללא כל שלב תקין', 'ג':'תגובה שמופיעה אך ורק מעבר לחודש מהאירוע', 'ד':'תגובה שאינה קשורה כלל לאירוע טראומטי'},
    correct:'א',
    explanation:{correct:'תגובת דחק חריפה (ASR) היא התגובה המיידית לאירוע טראומטי, ויכולה להימשך מספר שעות עד 3 ימים לאחר האירוע. הביטוי האופייני לה הוא \"הלם\" המלווה בקושי להגיב לסביבה. אם התגובה חולפת תוך 72 שעות היא נחשבת תקינה, לא פתולוגית — התסמינים יכולים לכלול חרדה, דיכאון, כעס, ייאוש, ניתוק, הסתגרות או תזזיתיות ללא מטרה, ובד\"כ חולפים ללא צורך בטיפול.',
  ...
  { id: 'GC_0357', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מתי מוגדרת \"הפרעת דחק חריפה\" (ASD), בשונה מ\"תגובת דחק חריפה\" (ASR)?',
    options:{'א':'כאשר התסמינים נמשכים מ-72 שעות ועד לחודש מהחשיפה לאירוע הטראומטי — כבר מוגדרת הפרעה (פתולוגית), לרוב כהמשך ישיר של תגובת הדחק החריפה', 'ב':'כאשר התסמינים חולפים תוך 24 שעות מהאירוע', 'ג':'כאשר התסמינים מופיעים אך ורק מעבר לשנה מהאירוע', 'ד':'אין הבדל מהותי כלשהו בין ASR ל-ASD'},
    correct:'א',
    explanation:{correct:'הפרעת דחק חריפה (ASD) מוגדרת כאשר התסמינים נמשכים מעבר ל-72 שעות מהחשיפה לאירוע ועד חודש — כלומר, כבר נחשבת פתולוגית, לרוב בהמשך ישיר לתגובת הדחק החריפה שקדמה לה. מטרת ההתערבות בשלב זה היא מניעת התפתחות תמונה כרונית יותר.',
  ...
  { id: 'GC_0358', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'כיצד מסווגת הפרעה בתר-חבלתית (PTSD) לפי משך הזמן מהאירוע?',
    options:{'א':'PTSD חריף (Acute) — עד 3 חודשים; PTSD כרוני (Chronic) — מעל 3 חודשים; וייתכן גם \"Late Onset\" — הופעה מאוחרת, שנים לאחר האירוע ולא מיד לאחריו', 'ב':'כל מקרי ה-PTSD מוגדרים אך ורק כרוניים, ללא קטגוריות משנה', 'ג':'PTSD מוגדר רק אם התסמינים הופיעו בתוך 72 השעות הראשונות מהאירוע', 'ד':'אין כל קטגוריות משנה ל-PTSD — כל המקרים זהים לגמרי'},
    correct:'א',
    explanation:{correct:'PTSD מאובחנת כאשר תגובת הדחק ממשיכה מעבר לחודש מהאירוע. מתת-חלוקה נוספת: Acute PTSD — עד 3 חודשים; Chronic PTSD — מעל 3 חודשים; וקיימת גם אפשרות של \"Late Onset\" — הופעה ראשונה של התסמונת שנים לאחר האירוע, ולא מיד.',
  ...
  { id: 'GC_0359', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:true,
    question:'אילו מהבאים נמנים על ארבע קטגוריות התסמינים המרכזיות של PTSD?',
    options:{'א':'חודרנות — זיכרונות/סיוטים/\"פלאשבק\" חוזרים של האירוע', 'ב':'הימנעות מגירויים המזכירים את האירוע, וניתוק/צמצום עניין בעולם החיצוני', 'ג':'עוררות יתר — רגישות מוגברת, קשיי שינה וריכוז ותחושת מתח מתמדת', 'ד':'שיפור מיידי וקבוע בתפקוד החברתי, מיד לאחר האירוע'},
    correct:['א', 'ב', 'ג'],
    explanation:{correct:'תסמונת PTSD מתאפיינת בארבע קטגוריות תסמינים מרכזיות: חודרנות (זיכרונות/סיוטים/פלאשבק), הימנעות (מגירויים המזכירים את האירוע וצמצום עניין), עוררות יתר (רגישות, קשיי שינה וריכוז) — וקטגוריה רביעית שנוספה לאחרונה: דיכאון ופגיעה קוגניטיבית.',
      wrong:'שיפור מיידי וקבוע בתפקוד אינו תסמין של PTSD — ההפך הוא הנכון: PTSD מאופיינת בקשיי תפקוד מתמשכים ולא בשיפור מיידי.'} },

  { id: 'GC_0360', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהם עקרונות ה-PIE בטיפול המיידי בנפגעי דחק?',
    options:{'א':'Proximity (קרבה — טיפול קרוב ככל האפשר למקום הפגיעה), Immediacy (מיידיות — טיפול מיידי), Expectancy (ציפייה — ציפייה להחלמה)', 'ב':'Prevention (מניעה), Isolation (בידוד), Evacuation (פינוי)', 'ג':'Pain (כאב), Injury (פגיעה), Emergency (חירום)', 'ד':'עקרונות אלו נוגעים אך ורק לטיפול תרופתי בנפגעי דחק'},
    correct:'א',
    explanation:{correct:'עקרונות PIE מנחים את הטיפול בנפגעי דחק: Proximity — טיפול קרוב ככל האפשר למקום הפגיעה; Immediacy — טיפול מיידי; Expectancy — ציפייה להחלמה. הטיפול כולל יצירת קשר טיפולי חיובי, קבלת אינפורמציה, מתן אוריינטציה/מידע, והפעלה (מתן אפשרות לפעולה עצמית להפחתת תחושת חוסר האונים).',
  ...
  { id: 'GC_0361', source:'generated', qtype:['scenario'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'הצוות שלך טיפל באירוע רב-נפגעים קשה. מהי המטרה המרכזית של \"שיחת הצוות\" (Debriefing) שיש לקיים בסמוך לסיום הטיפול?',
    options:{'א':'יצירת תמונה ברורה ומלאה של האירוע, בחינה לא-שיפוטית ולא-מאשימה של תפקוד הצוות, וחיזוק תחושת המקצועיות והביטחון האישי-צוותי, תוך יצירת אפשרות להביע רגשות ומחשבות', 'ב':'איתור אשמים והטלת אחריות אישית על טעויות שנעשו', 'ג':'השיחה נועדה אך ורק למילוי טפסים מנהליים ולתיעוד ביורוקרטי', 'ד':'אין צורך בשיחת צוות אלא אם היו אבדות בנפש באירוע'},
    correct:'א',
    explanation:{correct:'שיחת צוות (Debriefing) נועדה ליצור תמונה ברורה ומלאה של האירוע וכל מה שעשה הצוות, לבצע ניתוח לא-שיפוטי ולא-מאשים של תפקוד הצוות, ולחזק את תחושת ההצלחה המקצועית והביטחון האישי-צוותי, תוך יצירת אפשרות להביע רגשות ומחשבות — כל זאת מומלץ גם באירועים בהם לא היו אבדות בנפש, בכל אירוע משמעותי.',
  ...
  { id: 'GC_0362', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מי אמור להנחות את שיחת הצוות (Debriefing) בעקבות אירוע טראומטי?',
    options:{'א':'איש הצוות הבכיר (למשל ראש הצוות/מפקד המשמרת/מנהל התחנה) — המכיר את עקרונות הניהול הנכון של השיחה', 'ב':'תמיד גורם חיצוני שכלל לא נכח באירוע', 'ג':'אך ורק פסיכיאטר או פסיכולוג מוסמך', 'ד':'כל אחד מחברי הצוות, לפי סדר אקראי, ללא מנחה קבוע'},
    correct:'א',
    explanation:{correct:'ה-Debriefing מונחה ע\"י איש צוות בכיר — כמו ראש הצוות/מפקד המשמרת/מנהל התחנה — שמכיר את עקרונות הניהול הנכון של שיחה כזו, ולא בהכרח ע\"י איש מקצוע בבריאות הנפש. הדבר תואם את ההבנה שגם אנשי מד\"א (לא רק אנשי מקצוע בבריאות הנפש) הם גורם מוסמך ומשמעותי בעיבוד האירוע עם צוותם.',
  ...
  { id: 'GC_0363', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהי \"טראומטיזציה משנית\" (Vicarious Traumatization) ו\"שחיקה מחמת חמלה\" (Compassion Fatigue)?',
    options:{'א':'מצבים העלולים להתפתח אצל מטפלים בעקבות חשיפה ממושכת לקורבנות טראומה, ולחייב טיפול דומה לזה של נפגעי טראומה נפשית ישירים', 'ב':'מונחים המתארים אך ורק תגובה של נפגעים ישירים, ולא של צוותי חירום המטפלים בהם', 'ג':'מצב שאינו קשור כלל לעבודה עם נפגעי טראומה, אלא לתשישות פיזית בלבד', 'ד':'תופעה חד-פעמית שאינה חוזרת על עצמה גם בחשיפה חוזרת ונשנית'},
    correct:'א',
    explanation:{correct:'חשיפה ממושכת לקורבנות טראומה עלולה להביא לטראומטיזציה משנית ולשחיקה מחמת חמלה אצל צוותי החירום עצמם, לא רק אצל הנפגעים. כאשר סימנים כאלה מופיעים, יש לטפל בהם כמו בנפגעי דחק נפשי — לרבות שיחת צוות ועד לפנייה לעזרה מקצועית.',
  ...
  { id: 'GC_0364', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:true,
    question:'אילו מהבאים נמנים על עצות שימושיות מומלצות לצוותי חירום למניעת שחיקה וטראומטיזציה משנית?',
    options:{'א':'לשמור על פעילות גופנית סדירה, לאכול ולישון כראוי ולעבוד במשמרות סבירות', 'ב':'לחפש סימני דחק אצל עצמם ואצל חברי הצוות, ולדבר עם חברים/משפחה/עמיתים', 'ג':'לתרגל טכניקות המפחיתות מתח, כגון תרגילי נשימה, מדיטציה או מיינדפולנס', 'ד':'להימנע לחלוטין משיחה על האירועים עם כל אדם, כולל אנשי מקצוע'},
    correct:['א', 'ב', 'ג'],
    explanation:{correct:'העצות המומלצות כוללות: להישאר פעילים ולשמור על כושר גופני, לקחת הפסקות מדי פעם, לאכול ולישון כראוי, לעבוד במשמרות סבירות, לתרגל פעילות מפחיתת מתח (נשימה, מדיטציה, מיינדפולנס), לחפש סימני דחק אצל עצמם ואצל חברים, ולדבר עם חברים/משפחה/עמיתים — ואם מזוהים סימפטומים מתמשכים, לפנות לעזרה מקצועית.',
  ...
  { id: 'GC_0365', source:'generated', qtype:['scenario'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'נדרשת למסור הודעה על מוות לבני משפחת נפטר. מיהו הגורם שאמור למסור את ההודעה, וכיצד יש לעשות זאת?',
    options:{'א':'איש הצוות הבכיר והמנוסה ביותר, לאחר בירור קרבתם של הנוכחים למנוח, בצורה שקטה ותומכת ותוך היערכות למגוון תגובות אפשריות (בכי, כעס, ניתוק ועוד)', 'ב':'כל אחד מהצוות, ללא צורך בבירור זהות הנוכחים מראש', 'ג':'יש למסור את ההודעה בצורה מהירה וישירה ככל האפשר, ללא כל התחשבות ברגישות המצב', 'ד':'יש להימנע ממסירת הודעה כלל, ולהשאיר זאת תמיד לגורמים אחרים'},
    correct:'א',
    explanation:{correct:'ההודעה על מוות נמסרת ע\"י איש הצוות הבכיר, המנוסה ביותר במסירת הודעות קשות. יש לוודא הבנת הקרבה של הנוכחים למנוח לפני מסירת ההודעה, כדי להתאים את ההודעה לקבלה; להעביר את ההודעה בצורה שקטה ותומכת ככל שניתן; ולהיערך למגוון תגובות אפשריות — בכי, עצב, חרדה, תגובת נסיגה, ואף שקט/ניתוק. יש לדאוג לסיוע לקרובי הנפטר, למשל בקישור לבני משפחה נוספים.',
  ...
  { id: 'GC_0366', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'כיצד יש למסור הודעה על מוות בן משפחה לילד, בהתאם ליכולת ההבנה שלו לפי גיל?',
    options:{'א':'בליווי הורה/דמות קרובה, בהתאם ליכולת ההבנה של הגיל: עד גיל 7 קשה להסביר סיבתיות; בגילאי 7-10 קיימת הבנה חלקית אך ללא יכולת התמודדות עצמית; ומעל גיל 10 התגובות דומות יותר למבוגרים', 'ב':'יש למסור לילדים בכל גיל בדיוק את אותו ניסוח כמו למבוגרים, ללא כל התאמה', 'ג':'אין למסור הודעה על מוות לילדים כלל, בשום גיל', 'ד':'יש למסור את ההודעה לילד תמיד ללא נוכחות מבוגר קרוב'},
    correct:'א',
    explanation:{correct:'הודעה לילד על מוות בן משפחה ניתנת בליווי הורה (ההורה הנותר, במקרה של מות הורה) או דמות קרובה אחרת (כגון מורה), בהתאם לנסיבות ורצון המשפחה — כדי לדעת כיצד למסור את ההודעה בהתאם ליכולות ההכלה וההבנה של הילד. שלבי הבנת מושג המוות: עד גיל 7 — לא ניתן להסביר סיבתיות; 7-10 — הבנה חלקית אך אין יכולת התגברות עצמית; ומעל גיל 10 — תגובות דומות למבוגרים.',
  ...
  { id: 'GC_0367', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהו אחד המאפיינים הייחודיים של עזרה ראשונה נפשית הניתנת בטלפון או באינטרנט (כגון ער\"ן), בהשוואה למפגש פנים אל פנים?',
    options:{'א':'הפנייה נעשית בעילום שם — הן המתקשר והן המתנדב אינם מזוהים, מה שמקל על אנשים לפנות ולבקש עזרה למרות מגננה/סטיגמה מפני טיפול נפשי', 'ב':'זיהוי מלא של המתקשר הוא תנאי חובה בכל שיחה', 'ג':'השירות מיועד אך ורק למי שכבר אובחן במחלת נפש', 'ד':'אין כל צורך ביצירת קשר טיפולי גם בשיחה טלפונית'},
    correct:'א',
    explanation:{correct:'פניות לער\"ן הן בעילום שם — הן המתקשרים והן המתנדבים אינם מזוהים. תפיסת ער\"ן היא שגם מתנדבים שאינם אנשי מקצוע בבריאות הנפש יכולים ליצור אפקט משמעותי דרך יחס מקצועי ומרגיע. חלק מהפונים רואים בעצם הפנייה חלק ניכר מתהליך ההחלמה — כביטוי לתובנה שעליהם לקבל עזרה נפשית.',
  ...
  { id: 'GC_0368', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:true,
    question:'אילו מהבאים נחשבים לכללי התנהגות שיש להימנע מהם בשיחת עזרה ראשונה נפשית טלפונית/מקוונת?',
    options:{'א':'הטפת מוסר ושיפוטיות כלפי הפונה', 'ב':'מתן עצות מעשיות/תשובות ללא בקשה, וחקירת הפונה בשאלות מיותרות', 'ג':'התעלמות מדברי הפונה, או ניהול ויכוח עמו', 'ד':'הקשבה פעילה וביטוי אמפתי כלפי הפונה'},
    correct:['א', 'ב', 'ג'],
    explanation:{correct:'עקרונות ער\"ן דומים לעקרונות הטיפול הכללי: יש לדבר בכנות ולבטא אמפתיה, ולהקשיב הקשבה פעילה. יש להימנע מהטפת מוסר, שיפוטיות, מתן עצות מעשיות ללא בקשה, חקירה מיותרת, התעלמות מדברי הפונה, החלפת נושא, וניהול ויכוח עמו.',
  ...
  { id: 'GC_0369', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:true,
    question:'אילו מהבאים נמנים על ארבע מטרות הטיפול בדה-אסקלציה מילולית של חולה פסיכיאטרי סוער?',
    options:{'א':'הבטחת שלום המטופל, הצוות והנוכחים במקום', 'ב':'עזרה למטופל להשיג שליטה רגשית והתנהגותית', 'ג':'הימנעות ככל הניתן מהגבלות (כגון קשירה) ומטיפול כפוי', 'ד':'הרגעה מיידית באמצעות מתן תרופה בכפייה, כצעד ראשון'},
    correct:['א', 'ב', 'ג'],
    explanation:{correct:'ארבע מטרות הטיפול בחולה הסוער: הבטחת שלום המטופל, הצוות והנוכחים; עזרה למטופל להשיג שליטה רגשית והתנהגותית; הימנעות ככל הניתן מהגבלות (כגון קשירה); והימנעות ככל הניתן מהפעלת טיפול כפוי שעלול להביא להחרפת המצב הסוער.',
  ...
  { id: 'GC_0370', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'על מי חל \"חוק טיפול בחולי נפש, תשנ\"א 1991\", המאפשר טיפול פסיכיאטרי כפוי?',
    options:{'א':'רק על מי שכבר אובחן כחולה נפש ע\"י פסיכיאטר מחוזי (או בית משפט) — לא ניתן להשתמש בו כלפי מי שלא עבר הליך אבחון כזה', 'ב':'על כל אדם הנוהג באופן חריג, ללא צורך בכל הליך אבחוני מוקדם', 'ג':'אך ורק על מי שביצע עבירה פלילית', 'ד':'על כל חולה בבית חולים כללי, ללא הבדל בין חולה נפש לחולה גופני'},
    correct:'א',
    explanation:{correct:'החוק חל רק ומי שאובחן כחולה נפש ע\"י פסיכיאטר מחוזי (או בית משפט) — לא כל מצב נפשי חריג מקנה סמכות טיפול כפוי. \"צו בדיקה\" מאפשר לפנות לפסיכיאטר מחוזי לביצוע בדיקת מסוכנות; \"הוראת אשפוז\" ניתנת ע\"י הפסיכיאטר המחוזי (או סגנו) לאחר בדיקה, אם נמצאה מסוכנות — וניתן לערער עליה בפני ועדה פסיכיאטרית מחוזית תוך 5 ימים.',
  ...
  { id: 'GC_0371', source:'generated', qtype:['concept'], section:'עזרה ראשונה נפשית וחוסן', multi:false,
    question:'מהו ההבדל המרכזי בסכנת הגמילה בין אלכוהול לבין אופיאטים (כגון הרואין)?',
    options:{'א':'גמילה מאלכוהול עלולה לגרום לתסמונת Delirium Tremens עם פרכוסים עד כדי סכנת מוות — התסמונת המסוכנת ביותר מבין תסמונות הגמילה; לעומת זאת, גמילה מאופיאטים לרוב אינה מהווה סכנת מוות ישירה', 'ב':'שתי הגמילות מסוכנות באותה מידה בדיוק, ללא הבדל מהותי', 'ג':'גמילה מאופיאטים היא המסוכנת ביותר מכל סוגי הגמילה הקיימים', 'ד':'גמילה מאלכוהול אינה מסוכנת כלל, ואינה מצריכה כל השגחה'},
    correct:'א',
    explanation:{correct:'גמילה מאלכוהול עלולה להוביל לתסמונת Delirium Tremens (תסמונת הגמילה המסוכנת ביותר) — הכוללת תסמינים פסיכוטיים, בלבול ופרכוסים עד כדי סכנת מוות. לעומת זאת, גמילה מאופיאטים (כגון הרואין) לרוב אינה מהווה סכנת מוות ישירה, גם אם היא קשה ומכאיבה מאוד. לכן טיפול בגמילה מכל חומר ממכר חייב להתבצע בהשגחה רפואית המתאימה למידת הסכנה שלו.',
